...
scope.partEdgeZonelets.Set([15 , 17 , 15 , 14 , 16 , 13 , 12 , 10 , 9 , 8 , 7 , 11 , 6 , 5 , 4 , 3])
...
file_name = "C:\Users\mtthl\OneDrive\Documents\Education\Masters Thesis\git\APG_tranpsort\Patrick_CFD\Geometry\FM_DESKTOP-1N5CMU3_26500\2D_testsection.sf"
...
entities.partEdgeZonelets.Set([1 , 99])
...
entities.zoneExpression.Set("*")
entities.parts.Set([2])
entities.partFaceZonelets.Set([1 , 132])
...
shellbl_control_growth_params.growthRate = 1.050000
...
shellbl_control_growth_params.maxAspectRatio = 50.000000
...
entities.parts.Set([2])
entities.partFaceZonelets.Set([])
entities.partEdgeZonelets.Set([11 , 97 , 96 , 95 , 93 , 92 , 91 , 90 , 89 , 88 , 87 , 86])
entities.partTopoFaces.Set([])
entities.partTopoEdges.Set([])
entities.partVolumes.Set([])
...
shellbl_control_growth_params.gapFactor = 0.200000
shellbl_control_growth_params.firstHeight = 0.000030
shellbl_control_growth_params.maxHeight = 0.000100
shellbl_control_growth_params.firstAspectRatio = 5.000000
shellbl_control_growth_params.lastAspectRatio = 2.500000
shellbl_control_growth_params.minAspectRatio = 0.010000
shellbl_control_growth_params.maxAspectRatio = 50.000000
